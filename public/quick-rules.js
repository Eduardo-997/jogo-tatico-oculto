    ...
    <div class="qr-modal" role="dialog" aria-modal="true" aria-labelledby="qrTitle">
      ...
      <div class="qr-content">
        ...
        <section class="qr-page" data-page="personagens">
          ...
          ${visual(A.effects?.phantomPresence,'🧠 Presença Fantasma','Paranoia escolhe exatamente 2 casas dentro do Alc. Hab. 2. O dono vê as presenças; os inimigos não. Elas provocam PER como se fossem personagens. Um ataque comum faz o atacante acreditar que acertou o próprio Paranoia e causa uma nova detecção falsa desconhecida no próximo turno. Em Confronto Direto, o adversário descobre que era uma Presença Fantasma porque não sofre dano nem é repelido; ainda assim recebe uma detecção falsa conhecida no próximo turno.','Presença Fantasma')}
        ...
        <section class="qr-page" data-page="info">
          ...
          <div class="qr-card"><b>🧠 Efeito da Presença Fantasma</b><p>Se a presença for atacada normalmente, o jogador acredita que atingiu Paranoia e a próxima detecção falsa parece normal. Se a presença for descoberta em Confronto Direto, a próxima detecção também é falsa, mas o jogador sabe disso.</p></div>
